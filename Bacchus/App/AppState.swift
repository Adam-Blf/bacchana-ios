...
/// qu'un `Player` (BacchusCore) n'existe. `Codable` pour la persistance
...
final class AppState: ObservableObject {
    ...
    /// analytics (voir `BacchusCore.Player.gender` / `.relationship`).
    ...
    // now "bacchus." (v0.16.0, final product name).
    ...
    private let playerNamesKey = "bacchus.playerNames"
    private let playerAttributesKey = "bacchus.playerAttributes"
    private let themeModeKey = "bacchus.themeMode"
    private let analyticsConsentKey = "bacchus.analyticsConsent"
