...
/// Bacchus Premium paywall. Reachable from the Hub header ("Premium") and from any locked
...
struct PaywallView: View {
    ...
    private var purchaseButton: some View {
        Button {
            ...
            Text(isPurchasing ? "Achat en cours…" : (purchaseReady ? "Débloquer Bacchus Premium" : "Bientôt disponible"))
