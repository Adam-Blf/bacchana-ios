...
/// réinitialisation de la tablée. À parité avec `bacchus-site/src/components/screens/
...
/// (`BacchusCore` n'expose aucun type dédié), donc cette section est omise plutôt que
/// simulée - à porter quand le module existera côté `BacchusCore`.
///
...
/// `bacchus.beloucif.com` (v0.15.0, actif), source unique de vérité pour ces textes.
struct SettingsView: View {
    ...
    private static let legalURL = URL(string: "https://bacchus.beloucif.com")!
    ...
    private var legalSection: some View {
        SettingsSection(title: "Légal") {
            ...
            Text("Textes complets consultables sur bacchus.beloucif.com.")
