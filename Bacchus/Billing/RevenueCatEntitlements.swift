...
/// `PREMIUM_ENTITLEMENT_ID` (`bacchus-site/src/lib/billing.ts`) and the Android
/// `PREMIUM_ENTITLEMENT_ID` (`com.beloucif.bacchus.core.PremiumPlan`).
///
/// Product rename (v0.16.0, La Tournee -> Bacchus, final name): renamed to "Bacchus Pro"
...
private let premiumEntitlementID = "Bacchus Pro"
...
/// `EntitlementProviding` and `BacchusCore.PremiumPackage`, never RevenueCat types directly.
