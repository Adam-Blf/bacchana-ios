...
/// (`LaTaverneCore` n'expose aucun type dédié), donc cette section est omise plutôt que
/// simulée - à porter quand le module existera côté `LaTaverneCore`.
///
...
/// `lataverne.beloucif.com`, source unique de vérité pour ces textes.
