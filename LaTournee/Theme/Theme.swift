...
/// La Tournee design tokens: tavern neobrutalist palette. Every value below is
/// built from `LaTourneeCore.ThemePalette` - the single, platform-agnostic
/// source of truth shared with the CI contrast guard
/// (`LaTourneeTests/ContrastGuardTests.swift`) - which itself mirrors
...
extension SwiftUI.Color {
    ...
    /// Builds a dynamic `Color` straight from a `LaTourneeCore.ThemePalette`
