...
/// (`LaTourneeCore` n'expose aucun type dédié), donc cette section est omise plutôt que
/// simulée - à porter quand le module existera côté `LaTourneeCore`.
///
...
/// `latournee.beloucif.com` (v0.15.0, actif), source unique de vérité pour ces textes.
struct SettingsView: View {
    ...
    private static let legalURL = URL(string: "https://latournee.beloucif.com")!
    ...
    private var legalSection: some View {
        SettingsSection(title: "Légal") {
            ...
            Text("Textes complets consultables sur latournee.beloucif.com.")
