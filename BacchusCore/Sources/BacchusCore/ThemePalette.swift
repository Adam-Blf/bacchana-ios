...
/// Raw Bacchus design tokens - platform-agnostic (no SwiftUI/UIKit import),
/// so both the app's `Theme.Color` (SwiftUI, `Bacchus/Theme/Theme.swift`)
/// and the CI contrast guard (`BacchusTests/ContrastGuardTests.swift`) build
/// on the exact same source of truth. Mirrors
/// `bacchus-site/src/styles/tokens.css` and `docs/DESIGN_TOKENS.md` - never
