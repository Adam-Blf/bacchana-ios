...
/// Raw La Tournee design tokens - platform-agnostic (no SwiftUI/UIKit import),
/// so both the app's `Theme.Color` (SwiftUI, `LaTournee/Theme/Theme.swift`)
/// and the CI contrast guard (`LaTourneeTests/ContrastGuardTests.swift`) build
