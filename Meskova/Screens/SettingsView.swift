...
/// réinitialisation de la tablée. À parité avec `la-taverne/src/components/screens/
...
/// (`MeskovaCore` n'expose aucun type dédié), donc cette section est omise plutôt que
/// simulée - à porter quand le module existera côté `MeskovaCore`.
///
...
/// `lataverne.beloucif.com`, source unique de vérité pour ces textes. Domaine hérité du
/// nom de produit précédent (La Taverne) - à réaligner sur le domaine final Meskova une
/// fois la décision DNS/web prise côté Adam (hors périmètre de ce renommage iOS).
struct SettingsView: View {
    ...
    private static let legalURL = URL(string: "https://lataverne.beloucif.com")!
    ...
    private var legalSection: some View {
        SettingsSection(title: "Légal") {
            ...
            Text("Textes complets consultables sur lataverne.beloucif.com.")
