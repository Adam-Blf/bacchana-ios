...
/// `PREMIUM_ENTITLEMENT_ID` (`la-taverne/src/lib/billing.ts`) - do not rename without migrating
/// the dashboard entitlement, existing subscribers would lose access.
///
/// Product rename (v0.14.0, La Taverne -> Meskova): this literal is intentionally left
...
/// `EntitlementProviding` and `MeskovaCore.PremiumPackage`, never RevenueCat types directly.
